...
public class StepsovcCaseControllerTest {
    ...
    public void setup() {
        initMocks(this);
        stepsovcCaseController = new StepsovcCaseController(mockBeneficiaryHandler, mockNewReferralHandler, mockUpdateReferralHandler, mockUpdateServiceHandler, velocityEngine);

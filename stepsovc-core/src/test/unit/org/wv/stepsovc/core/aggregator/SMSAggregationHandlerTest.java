...
public class SMSAggregationHandlerTest {
    ...
    public void shouldGroupByPhoneNumberDeliveryTimeAndGroupKey() {
        ...
        assertThat(smsAggregationHandler.groupId(new SMSMessage(deliveryTime, phoneNumber, "c1", groupKey, "2-Apr-2012"))
                , is("G-FACILITY-Referral|087654321|2012-04-02-23:02"));
        assertThat(smsAggregationHandler.groupId(new SMSMessage(newDateTime(2012, 4, 2, 11, 2, 0), phoneNumber, "c2", groupKey, "2-Apr-2012"))
    ...
    public void shouldReturnCanBeDispatchedBasedOnDeliveryTime() {
        ...
        final List<SMSMessage> smsMessages = asList(new SMSMessage(deliveryTime, "phoneNumber", "c1", "groupKey", "2-Apr-2012"),
                new SMSMessage(deliveryTime, "phoneNumber", "c1", "g2", "2-Apr-2012"));

        assertTrue(smsAggregationHandler.canBeDispatched(smsMessages));
        assertFalse(smsAggregationHandler.canBeDispatched(asList(new SMSMessage(now().plusHours(1), "pN", "c1", "g1", "2-Apr-2012"))));
    }
}
